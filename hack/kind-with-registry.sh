...
# NOTE: Modified version of: https://github.com/kubernetes-sigs/cluster-api/blob/main/hack/kind-install-for-capd.sh

# This script installs a local kind cluster with a local container registry to test Cluster API.
